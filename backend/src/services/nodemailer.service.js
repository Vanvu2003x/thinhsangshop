...
<body style="margin: 0; padding: 0; background-color: ${THEME.bgDeep}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; -webkit-font-smoothing: antialiased;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">
        ${subtitle || title} - Pompomnapgame.com
    </div>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 20px;">
                                        <img src="cid:logo" alt="Pompom" style="height: 40px; border-radius: 8px;">
                                    </td>
                                </tr>
                                <!-- Tagline -->
                                <tr>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 25px;">
                                        <a href="${process.env.FRONTEND_URL || "https://pompomnapgame.com"}" style="color: ${THEME.primary}; text-decoration: none; font-size: 14px; margin: 0 12px;">Trang chủ</a>
                                        <span style="color: ${THEME.borderAccent};">•</span>
                                        <a href="${process.env.FRONTEND_URL || "https://pompomnapgame.com"}/user/history" style="color: ${THEME.primary}; text-decoration: none; font-size: 14px; margin: 0 12px;">Lịch sử</a>
                                        <span style="color: ${THEME.borderAccent};">•</span>
                                ...
                                <tr>
                                    <td align="center">
                                        <p style="margin: 0; color: ${THEME.textMuted}; font-size: 12px; line-height: 1.6;">
                                            © 2026 Pompom. All rights reserved.<br>
...
async function sendOTP(email, otp) {
    try {
        ...
        Chào mừng bạn đến với <strong style="color: ${THEME.textPrimary};">Pompom</strong>! Để hoàn tất đăng ký, hãy nhập mã xác minh bên dưới.
                        </p>
                    </td>
                </tr>
            </table>
        ...
        from: `"Pompom" <${process.env.SMTP_USER}>`,
            to: email,
...
<body style="margin: 0; padding: 0; background-color: #050505; font-family: 'Inter', system-ui, -apple-system, sans-serif;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #050505; background-image: radial-gradient(circle at 50% 50%, #1a1a2e 0%, #050505 100%);">
        ...
        Chúc mừng! Giao dịch của bạn tại <strong style="color: #ffffff;">Pompom</strong> đã được xử lý thành công. Dưới đây là thông tin tài khoản của bạn:
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center">
                                        <a href="${process.env.FRONTEND_URL || "https://pompomnapgame.com"}/account?tab=acc-history" style="display: inline-block; background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); color: #ffffff; padding: 18px 35px; border-radius: 15px; text-decoration: none; font-weight: 700; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 10px 20px rgba(99, 102, 241, 0.3);">
                ...
                <img src="cid:logo" alt="Pompom Logo" style="height: 35px; border-radius: 8px; margin-bottom: 20px; opacity: 0.8;">
                            <p style="margin: 0; color: #52525b; font-size: 12px; line-height: 1.8;">
                © 2026 Pompomnapgame.com - Hệ thống nạp game tự động hàng đầu.<br>
    ...
    try {
        ...
        const content = `
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td align="center">
                        <a href="${process.env.FRONTEND_URL || "https://pompomnapgame.com"}/user/history" style="display: inline-block; background: ${THEME.gradientPrimary}; color: #FFFFFF; padding: 16px 40px; border-radius: 50px; text-decoration: none; font-weight: 600; font-size: 14px; box-shadow: 0 8px 20px ${THEME.primaryGlow};">
...
<body style="margin: 0; padding: 0; background-color: #030712; font-family: 'Segoe UI', system-ui, -apple-system, sans-serif;">
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: linear-gradient(180deg, #030712 0%, #0f172a 100%);">
        ...
        Cảm ơn bạn đã tin tưởng sử dụng dịch vụ tại <strong style="color: #ffffff;">Pompom</strong>! 🎮
                            </p>
                ...
                <img src="cid:logo" alt="Pompom" style="height: 35px; border-radius: 8px; opacity: 0.9;">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                ...
                © 2026 Pompomnapgame.com - Nạp game uy tín hàng đầu Việt Nam
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 40px 35px;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="${process.env.FRONTEND_URL || "https://pompomnapgame.com"}" style="display: inline-block; background: transparent; border: 2px solid #78716c; color: #d6d3d1; padding: 14px 35px; border-radius: 50px; text-decoration: none; font-weight: 600; font-size: 13px;">
                                            🔄 Đặt đơn mới
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="background: #0c0a09; padding: 30px; border-top: 1px solid #1c1917;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 15px;">
                <img src="cid:logo" alt="Pompom" style="height: 35px; border-radius: 8px; opacity: 0.8;">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                        <p style="margin: 0; color: #57534e; font-size: 12px; line-height: 1.8;">
                © 2026 Pompomnapgame.com - Nạp game uy tín hàng đầu Việt Nam<br>
