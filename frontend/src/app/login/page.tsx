...
import { Mail, KeyRound, AlertTriangle, ShieldCheck } from 'lucide-react';
          ...
          <div className="bg-white border border-zinc-150 p-8 sm:p-10 rounded-[2rem] shadow-xl">
            ...
            {success && (
              <div className="flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 rounded-xl p-3.5 text-xs mb-6 font-semibold">
                ...
                <span>Đăng nhập thành công! Đang chuyển hướng về trang chủ...</span>
              </div>
            )}
            ...
            <div className="mt-6 text-center text-xs text-zinc-500 font-medium">
              <p>Chưa có tài khoản? <Link href="/register" className="text-blue-600 hover:text-blue-500 font-bold transition">Đăng ký thành viên</Link></p>
            </div>
          </div>
        </div>
      </main>
